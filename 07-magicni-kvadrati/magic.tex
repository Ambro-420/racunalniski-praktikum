...
\begin{figure}[!ht]
   \centering
   \includegraphics[width=0.5\textwidth]{sagrada.png} % Prilagoditev velikosti slike
...
\begin{table}[ht]
   ...
   \label{table:stevila} % oznaka: table:stevila
